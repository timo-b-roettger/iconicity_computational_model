...
### Signal ease
Smaller referents closer to their prototype (=c(0,0)) are easier to guess, and vice versa. Signal ease is an attractor that expresses distance to iconicity target/prototype, multiplied with iconicity boost to adjust for larger influence of iconicity.

### Probability of correct guess
p(correct guess) = listener memory + signal, type --> learned ability (priors) + iconicity boost * signal ease
